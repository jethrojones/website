...
last_modified_at: 2025-11-19 10:05:55
---


{% if page.image %} <img src="{{ page.image }}" alt=""> {% endif %}

I use [Descript](https://get.descript.com/swu3aooczakr) because it is the best out there. They're constantly making it better, too. I use it for anything where I have recorded audio or video. 
